...
@Component({
  selector: 'app-hoursatgym-chart',
  templateUrl: './hoursatgym-chart.component.html',
  styleUrls: ['./hoursatgym-chart.component.css']
})
export class HoursAtGymChartComponent implements OnInit{
  ...
  fetchData(nrDays:number) {
    this.http.get<any>(`http://localhost:8081/record/getHoursAtGym?days=${nrDays}`).subscribe(
      data => {
